  ...
  <div class="row">
      ...
      <!--   <div class="col s12 m4 l3"> 
		...
		<div class="row" style="margin-top: 5%;">
			<div class="container">
			<p>Hosted Tournaments</p>
			<div>
			    <c:forEach items="${hostedTournamentList}" var="element">
					<p><a href="<c:url value='/host/hostedtournament/${element.getTournamentId()}' />" ><c:out value="${element.tournamentName}" /></a></p>
				</c:forEach>
			  </div>
			  </div>
		</div>
  	...
  	<form action="/HelloWeb/tournamentNewForm" method="POST">
  		<button class="btn waves-effect waves-light">Add Tournament<i class="material-icons right">send</i>
		</button>
	</form>
